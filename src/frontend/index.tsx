...
import positionsRefined from '../data-processed.json'// assert { type: "json" }
...
function App () {
  return (
    <div className='bg-themeable-background h-screen text-themeable-foreground'>
      <Nav />
      <PositionsTable positions={positionsRefined as PositionRefined[]} />
    </div>
  )
}
