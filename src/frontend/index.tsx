...
export interface NavProps {
  setTheme: (theme: 'dracula' | 'material') => void
  theme: Theme
}
      ...
      <div className='flex items-center space-x-6'>
        <button
          ...
          className='inline-flex text-xl p-2 items-center' onClick={() => {
            setTheme(theme === 'dracula' ? 'material' : 'dracula')
          }}
        >
